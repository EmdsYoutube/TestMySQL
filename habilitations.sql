...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 15 mai 2022 à 13:32
...
ALTER TABLE developpeur
  ...
  ADD KEY FK_developpeur_profil (idprofil);
...
ALTER TABLE habilitation
  ...
  ADD KEY FK_habilitation_operation (idoperation),
  ADD KEY FK_habilitation_profil (idprofil);
...
--
ALTER TABLE profil
  MODIFY idprofil int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE developpeur
  ADD CONSTRAINT developpeur_ibfk_1 FOREIGN KEY (idprofil) REFERENCES profil (idprofil);

--
-- Contraintes pour la table habilitation
--
ALTER TABLE habilitation
  ADD CONSTRAINT habilitation_ibfk_1 FOREIGN KEY (idfonctionnalite) REFERENCES fonctionnalite (idfonctionnalite),
  ADD CONSTRAINT habilitation_ibfk_2 FOREIGN KEY (idoperation) REFERENCES operation (idoperation),
  ADD CONSTRAINT habilitation_ibfk_3 FOREIGN KEY (idprofil) REFERENCES profil (idprofil);
COMMIT;
